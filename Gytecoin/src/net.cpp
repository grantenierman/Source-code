...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Gytecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"gytecointools.com", "dnsseed.gytecointools.com"},
    {"gytecoinpool.org", "dnsseed.gytecoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"gytecointools.com", "testnet-seed.gytecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Gytecoin is probably already running."), addrBind.ToString().c_str());
        else
